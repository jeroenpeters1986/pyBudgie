"""
Django config for pybudgie project.
...
INSTALLED_APPS = [
    ...
    "budgie_breeding.apps.BudgieBreedingConfig",
...
WSGI_APPLICATION = "pybudgie.wsgi.application"
